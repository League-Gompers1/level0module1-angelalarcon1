...
public class NasaCountdown {
	public static void main(String[] args) {
		...
		String ans =JOptionPane.showInputDialog(null, "When do you want to start");
	
		// 3. convert the user's answer to an int (Integer.parseInt)
	int startingnumber=Integer.parseInt(ans);
...
for(int i=startingnumber; i >= 0; i=i-1){
	System.out.println(i);
}}
		// 5. when the counting is done, print "blastoff!"
	
 JOptionPane.showInputDialog(null, "BlastOff");
